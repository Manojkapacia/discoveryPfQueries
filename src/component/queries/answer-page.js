...
import { PeopleFill,Eye,Share } from 'react-bootstrap-icons';
        ...
        <div className='container mt-5'>
            <div className='row'>
                ...
                <div className='col-lg-6 mt-2 mt-lg-0'>
                    ...
                    <button className='border-0 assistButton px-3 py-1'>
                    <PeopleFill  size={13} color="#333366" /> 134 Assisted</button>
                    <button className='border-0 ms-2 px-3 py-1 viewButton'>
                    <Eye size={13} /> 1.5k views</button>
                    <button className='border-0 shareButton float-end'>
                    <Share size={13} /> Share</button>
                ...
                <div className='col-lg-3'>
                    <div className='bg-column px-2 rounded d-flex flex-column justify-content-end'>
                    ...
                    <label className='queries mt-2' style={{ color: '#7D7D7D' }}>Relevant Queries</label>

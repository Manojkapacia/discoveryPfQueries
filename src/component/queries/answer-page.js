        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-3'>
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <button className='w-100 addMore p-2'>Add More to List</button>
                        </div>
                    </div>
                </div>
                <div className='col-lg-6'>
                    ...
                    <p className='listDetails'>In a world where banking and financial services & processes can be overwhelming, FinRight is here to simplify things and offer end to end assistance to customers on several matters of personal finance. Founded in Mumbai in October 2023 by a team with experience at leading companies like CRED and Amazon & backed some of the renowned angel investors in the industry we help resolve the complex issues that come with managing personal finances—whether it’s withdrawing your Provident Fund (PF), optimising interest rate on home loan, settling insurance claims & tax planning.
                ...
                <div className='col-lg-3'>
                    <div className='bg-column px-2 rounded'>
                        <label className='imageHeading'>Talk to an expert for free</label>
                        <p className='imageText'>Our Experts Assistance provides end-to-end financial issue
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-6 text-center'>
                                <button className='border-0 contactBtn px-2 py-2'>Contact us now</button>
                            </div>
                        </div>
                    </div>
